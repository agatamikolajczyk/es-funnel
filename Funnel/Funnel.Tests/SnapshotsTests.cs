...
{
    [Migration(1, "Create cart table")]
        public class CreateCart: Migration
        {
            protected override void Up()
            {
                Execute("CREATE TABLE CARTS (id uuid PRIMARY KEY, username text)");
            }
        ...
        public SnapshotsTests()
        {
            ...
            var databaseProvider =
                new PostgresqlDatabaseProvider(databaseConnection) { SchemaName = typeof(SnapshotsTests).Name };
            ...
            var snapshotTest = new SnapshotToTable<Cart>(
                databaseConnection,
            ...
            eventStore.AddSnapshot(snapshotTest);
